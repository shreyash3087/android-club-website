...
const GeneralFormA = ()=>{
 ...
 <motion.form onSubmit={handleSubmit(onSubmit)} className=" form absolute right-10 bottom-36 bg-[#96BE96] flex flex-col border-white border-2 items-start gap-16 p-10 w-2/5 rounded-lg"
    ref={ref2}
              initial="hidden"
